...
const CurrentData = () => {
  ...
  return (
    <div className="currentDataCard flex flex-col gap-2 items-start justify-center p-3 sm:p-4 rounded-xl text-font-light-primary dark:text-font-dark-primary bg-base-light-secondary dark:bg-base-dark-secondary">
