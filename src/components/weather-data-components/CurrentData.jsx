  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        layout
        className="currentDataCard flex flex-col h-fit gap-2 items-start justify-center p-3 sm:p-5 rounded-2xl text-font-light-primary dark:text-font-dark-primary bg-base-light-secondary dark:bg-base-dark-secondary"
      >
        ...
        <div className="weatherInfo w-full flex items-center justify-center">
          <figure className="icon w-[60%]">
            <WeatherIcon weatherMain={locationRawData.weather[0].main} classBlob={"w-30 sm:w-34 h-30 sm:h-34"} />
          </figure>
